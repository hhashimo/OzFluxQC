...
us_of,f = qcutils.GetSeriesasMA(ds_of,'ustar',si=si,ei=ei)
us_ep,f = qcutils.GetSeriesasMA(ds_ep,'ustar')
Fh_of,f = qcutils.GetSeriesasMA(ds_of,'Fh',si=si,ei=ei)
Fh_ep,f = qcutils.GetSeriesasMA(ds_ep,'Fh')
Fe_of,f = qcutils.GetSeriesasMA(ds_of,'Fe',si=si,ei=ei)
Fe_ep,f = qcutils.GetSeriesasMA(ds_ep,'Fe')
Fc_of,f = qcutils.GetSeriesasMA(ds_of,'Fc',si=si,ei=ei)
Fc_ep,f = qcutils.GetSeriesasMA(ds_ep,'Fc')
